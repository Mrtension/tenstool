...
|___|_|    |____\___\___|_\_\ \_,_| .__/  
    ...
    """)
      ...
      HTTP HEADER
      """)
      os.system("curl https://api.hackertarget.com/httpheaders/?q=" + d3 )
      print("")
      quit()
    elif choice == 9:
      d3 = raw_input('Enter IP Or Domain :  ')
      ...
      GRAB BANNER
      """)
      os.system("curl https://api.hackertarget.com/bannerlookup/?q=" + d3 )
      print("")
      quit()
    elif choice == 10:
      d3 = raw_input('Enter domain :  ')
      ...
      print("""
       SUBDOMAIN SCANNER
       """)
      os.system("curl https://api.hackertarget.com/hostsearch/?q= " + d3 )
      print("")
      quit()
    elif choice == 11:
      ...
      print("""
        IP TRACER
       """)
      os.system("curl https://ipapi.co/json" + d3 )
      print("")
      quit()
